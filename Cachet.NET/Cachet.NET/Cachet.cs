namespace Cachet.NET
{
    ...
    public partial class CachetServer
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CachetServer"/> class.
        /// </summary>
        /// <param name="Host">The host.</param>
        /// <param name="ApiKey">The API key.</param>
        public CachetServer(string Host, string ApiKey)
        {
            this.Hostname = Host;
            this.ApiKey = ApiKey;
        ...
        public CachetServer(string Host, string Email, string Password)
        {
            this.Hostname = Host;
